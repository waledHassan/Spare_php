                  ...
                  <div class="table-wrapper table-responsive">
                    <table class="table">
                      ...
                      <?php
                        ...
                        $users = $conn -> prepare("SELECT * FROM users WHERE GroupID != 1");
                        $users -> execute();
                        $rows= $users -> fetchAll();
          ...
          <td class="min-width">
            <div class="lead">
              <div class="lead-image">
                <img 
                  src="assets/images/users/<?php echo $row['avatar'] ?>"
                />
              </div>
              <div class="lead-text">
            ...
            <div class="row align-items-center">
              <div class="col-md-6">
                <div class="titlemb-30">
                  <h2>Settings </h2>
                    <a href="contact_user.php?id=<?php echo $id?>" class='btn btn-primary'>Contact <?php echo $user['firstname'] ?></a>
                </div>
              </div>
              <!-- end col -->
              <div class="col-md-6">
                ...
                <div class="profile-info">
                  <div class="d-flex align-items-center mb-30">
                    <div class="profile-image">
                      <img src="assets/images/users/<?php echo $user['avatar'] ?>" style='width:90px;height: 100px;' />
...
<?php
     ...
     foreach($formErrors as $error){
      echo "<div class='alert alert-danger container text-center'>" .$error. "</div>";
      header("refresh:2;url=users.php?action=add");
      ...
      if(empty($formErrors)){
        ...
        move_uploaded_file($avatartmp , "assets\images\users\\" . $avatar);
      ...
      if($count == 1){
          ...
          $stmt = $conn -> prepare("INSERT INTO users
                                (firstname, lastname, email, city, location,jop, phone, avatar , password , Date, GroupID , approve)
                        VALUES
                                (:firstname , :lastname , :email , :city, :location , :jop , :phone, :avatar, :password , now() , 0, 1)");
            $stmt -> execute(array(
            'firstname'   => $firstname,
            'lastname'    => $lastname,
            'email'       => $email,
