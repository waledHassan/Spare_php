<?php
  ...
  if(isset($_SESSION['admin'])){
     ...
     include("functions/function.php");
      ...
      $stmt_user = $conn -> prepare("SELECT * FROM users WHERE admin = 0 AND GroupID = 0 LIMIT 20");
      ...
      $stmt = $conn -> prepare("SELECT * FROM cars_wishlist LIMIT 20");
      $stmt -> execute(array());
      $count = $stmt -> rowCount();
      $rows = $stmt -> fetchAll();
 
      // $stmt1 = $conn -> prepare("SELECT * FROM wishlist WHERE user_id = ?");
      // $stmt1 -> execute(array($user_id));
      // $count_wish = $stmt1 -> rowCount();
          ...
          <div class="row">
            <div class="col-xl-3 col-lg-4 col-sm-6">
              <div class="icon-card mb-30">
                ...
                <div class="content">
                  <h6 class="mb-10">Cars</h6>
                  <h3 class="text-bold mb-10"><?php echo $count?></h3>
            ...
            <div class="col-xl-3 col-lg-4 col-sm-6">
              <div class="icon-card mb-30">
                ...
                <div class="content">
                  ...
                  <h3 class="text-bold mb-10"> <?php $count = [];
                      foreach($rows as $row){
                        $product_id = $row['id'];
                     ...
                     foreach($products as $product){       
                       ...
                       print_r(array_sum($count) * $row['quantity'] );          
                    ?>
            ...
            <div class="col-xl-3 col-lg-4 col-sm-6">
              <div class="icon-card mb-30">
                ...
                <div class="content">
                  ...
                  <h3 class="text-bold mb-10"><?php echo $count_users?></h3>
                  <p class="text-sm text-danger">
